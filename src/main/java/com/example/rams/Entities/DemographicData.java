...
public class DemographicData {
    ...
    private Area areaForDemographic;
    ...
    public Area getAreaForDemographic() {
        return areaForDemographic;
    }

    public void setAreaForDemographic(Area areaForDemographic) {
        this.areaForDemographic = areaForDemographic;
    }
}